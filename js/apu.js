...
class ApuEngine {
     ...
     * @param {Object} apuItem - El ítem APU a calcular.
     * @param {Array} materialsList - Lista actual de materiales.
     * @param {Array} laborList - Lista actual de mano de obra.
     * @returns {Object} Desglose completo de costos y precio unitario final.
     */
    calculateItemPrice(apuItem, materialsList, laborList) {
     ...
     * @param {Array} itemsPresupuesto - Ítems cargados en el presupuesto con cantidad y precio unitario.
     ...
     */
    calculateBudgetTotals(itemsPresupuesto, margenGanancia = 0, impuestos = 0) {
    ...
    /**
     * Obtiene el historial de precios facturados para un ítem APU específico.
     * @param {string} apuId - ID del ítem APU.
     * @param {Array} budgets - Lista de presupuestos guardados.
     * @returns {Array} Lista ordenada por fecha con los precios unitarios históricos asignados.
     */
    getHistoricalPrices(apuId, budgets) {
        const history = [];
     ...
     */
    getPriceGuide(apuId, currentCalculatedPrice, budgets) {
