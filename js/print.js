...
ObraUI.prototype.printBudget = function () {
...
ObraUI.prototype.renderPdfSettings = function (container) {
...
ObraUI.prototype.handleLogoUpload = function (event) {
    const file = event.target.files[0];
    if (!file)
        return;
    const reader = new FileReader();
    reader.onload = (e) => {
        document.getElementById('compLogoBase64').setAttribute('value', e.target.result);
        this.updateLivePdfPreview();
    };
    reader.readAsDataURL(file);
};
ObraUI.prototype.clearCompanyLogo = function () {
...
ObraUI.prototype.updateLivePdfPreview = function () {
...
ObraUI.prototype.saveCompanyProfile = function () {
